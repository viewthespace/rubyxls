...
describe Rubyxml::Builders::CellBuilder do
  let(:model_data_rows) {
                     [
  ...
  describe '#cells' do
    ...
    describe 'row numbers' do
      ...
      subject { Rubyxml::Builders::CellBuilder.new(model_data_rows: model_data_rows, start_row: 2, start_column: "B").cells.map { |cell| cell[:row] } }
    ...
    describe 'column letters' do
      ...
      context 'single letter' do
        ...
        subject { Rubyxml::Builders::CellBuilder.new(model_data_rows: model_data_rows, start_row: 2, start_column: "B").cells.map { |cell| cell[:column] } }
      ...
      context 'multi letter' do
        ...
        subject { Rubyxml::Builders::CellBuilder.new(model_data_rows: model_data_rows, start_row: 2, start_column: "AZ").cells.map { |cell| cell[:column] } }
